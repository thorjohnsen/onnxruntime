...
static TestModelInfo* CreateModelInfo(const PerformanceTestConfig& test_config) {
...
int real_main(int argc, char* argv[]) {
  ...
  auto test_model_info_ = CreateModelInfo(test_config);
  auto test_case_ = CreateOnnxTestCase(narrow_model_name, test_model_info_, 0.0, 0.0);
  ...
  SampleLoader s(sess,test_case_);
